...
!*******************************************************************************
! Routine determines Chorus and hiss wave power (pT)^2 and fpe/fce as
...
! Output: CHpower,UBCpower,HIpower,ompe,r_wave (through module cWpower)
    ...
    ! Determine AE level in chorus wave power data provided by
    ! Meredith
    if (UseKpIndex) then
       if (Kp.lt.2.) iae=1
...
!*****************************************************************************'
    ! Routine calculates the lower band Chorus power in (pT)^2 by
...
!*****************************************************************************'
    ! Routine calculates the upper band Chorus power in (pT)^2 by
    ! Gaussian fits provided by Qiuhua.
...
!*****************************************************************************'
    ! Routine calculates the CRRES hiss power in (pT)^2 by Gaussian
    ! fits provided by Qiuhua.
