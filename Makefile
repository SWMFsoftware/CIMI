...
test_check_WAVES:
	${SCRIPTDIR}/DiffNum.pl -r=0.001 -a=1e-10 \
		...
		output/CrcmFlux_e.fls.WAVES \
		> test_e_fls_WAVES.diff
	${SCRIPTDIR}/DiffNum.pl -r=0.001 -a=1e-10 \
		${TESTDIR}/IM/plots/CrcmPSD_e.psd \
		output/CrcmPSD_e.psd.WAVES \
		> test_e_psd_WAVES.diff
	${SCRIPTDIR}/DiffNum.pl -r=0.001 -a=1e-10 \
		${TESTDIR}/IM/plots/CRCMeq.outs \
		output/CRCMeq.outs.WAVES \
		> test_eq_WAVES.diff
	${SCRIPTDIR}/DiffNum.pl -r=0.001 -a=1e-10 \
		${TESTDIR}/IM/plots/CRCM.log \
		output/CRCM.log.WAVES \
		> test_log_WAVES.diff
...
test_check_psd:
	${SCRIPTDIR}/DiffNum.pl -r=0.001 -a=1e-10 \
		${TESTDIR}/IM/plots/CrcmPSD_h.psd \
		output/CrcmPSD_h.psd \
		> test_h_psd.diff
	${SCRIPTDIR}/DiffNum.pl -r=0.001 -a=1e-10 \
		${TESTDIR}/IM/plots/CrcmPSD_o.psd \
		output/CrcmPSD_o.psd \
		> test_o_psd.diff
	${SCRIPTDIR}/DiffNum.pl -r=0.001 -a=1e-10 \
		${TESTDIR}/IM/plots/CrcmPSD_e.psd \
		output/CrcmPSD_e.psd \
		> test_e_psd.diff
...
test_check_Prerun:
	...
	${SCRIPTDIR}/DiffNum.pl -r=0.001 -a=1e-10 \
		${TESTDIR}/IM/plots/CrcmPSD_h.psd \
		output/CrcmPSD_h.psd.Prerun \
		> test_h_psd_Prerun.diff
	${SCRIPTDIR}/DiffNum.pl -r=0.001 -a=1e-10 \
		${TESTDIR}/IM/plots/CrcmPSD_o.psd \
		output/CrcmPSD_o.psd.Prerun \
		> test_o_psd_Prerun.diff
	${SCRIPTDIR}/DiffNum.pl -r=0.001 -a=1e-10 \
		${TESTDIR}/IM/plots/CrcmPSD_e.psd \
		output/CrcmPSD_e.psd.Prerun \
