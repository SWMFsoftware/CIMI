...
! term. A preconditioned restarted GMRES routine is used to solve this equation.
subroutine gimme_potential
  use ModGridIono,    only: UseFullSphere,nTheta,nPhi,Theta_G, Phi_G, Riono, &
       dPhi, iThetaGround, iPhiGround, Potential_G
  use ModConductance, only: A_C,B_C,C_C,D_C,E_C,SigmaP_G,SigmaH_G,Sigma0_G
  use ModMagInput,    only: Jr_C,DoCoupleCimi,iThetaBC_I,PotBC_C
...
end subroutine gimme_potential
