...
!!! HWM-14 Beta (Douglas P. Drob, NRL 7632) 
!!! FOUO (Draft research model version subject to errors, not for public release)
...
!    character(128), parameter  :: dwmdefault = 'dwm07b_104i.dat'
    character(128), parameter  :: dwmdefault = 'dwm07b_104i.inp'
